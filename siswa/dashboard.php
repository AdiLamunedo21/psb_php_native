              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di SMP Terpadu Nurul-Huda Tanah Merah. Pengumuman pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">15 Januari 2023</span>
                  </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi di SMP Terpadu Mandiri. Lakukan Daftar Ulang pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">15 Januari 2022</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMP TERPADU NURUL HUDA | Nurul-Huda Tanah Merah</marquee>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <p class="text-danger mt-3">* Wajib melakukan Daftar Ulang pada tanggal: 15 Januari 2022</p>
            </div>
          </div>
        </div>
