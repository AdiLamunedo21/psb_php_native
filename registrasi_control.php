...
if(isset($_POST['btn_registrasi'])) {
    ...
    $sql_user = "INSERT INTO users (nama, username, password, level) values ('$nama', '$nisn', '$password', 'siswa')";
    ...
    if($result_user){
        ...
        $sql_pendaftar = "INSERT INTO pendaftar (nama, tmpt_lahir, tgl_lahir, jenis_kelamin, agama, alamat, nisn, telepon, users_id) values ('$nama', '$tempat_lahir', '$tanggal_lahir', '$jenis_kelamin', '$agama', '$alamat', '$email', '$telepon', '$id_user')";

        $result_pendaftar = mysqli_query($koneksi, $sql_pendaftar);

        if($result_pendaftar){
            // jika berhasil
            $_SESSION['pesan_registrasi'] = "Registrasi Berhasil, Login Menggunakan NISN dan Password anda!";
