...
<img src="http://localhost/pendaftaran/assets/img/logo_nurulhuda.png" style="float: left; height: 60px">

<div style="margin-left: 20px">
    <div style="font-size: 18px">Data Pendaftaran Siswa Baru | Tahun 2023</div>
    <div style="font-size:20px">SMP TERPADU Pondok Pesantren Terpadu Nurul-huda</div>
    <div style="font-size: 12px">Dusun Tanah Merah, Madang raya, Kabupaten Oku-timur, Sumatera Selatan 00000</div>
</div>
...
if($data_pendaftar['foto'] != '') {
    $gambar = 'http://localhost/pendaftaran/uploads/' . $data_pendaftar['foto'];
} else {
    // $gambar = '../assets/img/avatar.jpg';
    $gambar = 'http://localhost/pendaftaran/assets/img/avatar.jpg';
}
